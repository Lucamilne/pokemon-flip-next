...
export default function PlayPage() {
  ...
  return (
    <>
      ...
      <button title="How to play" onClick={() => setIsOpen(true)} className={`absolute top-44 md:top-18 right-2 md:right-5 transition-transform hover:scale-110 hover:drop-shadow/30 cursor-pointer ring-2 ring-white shrink-0 grow-0 w-9 h-9 transition-colors bg-blue-500 rounded-full flex items-center justify-center overflow-hidden`}>
