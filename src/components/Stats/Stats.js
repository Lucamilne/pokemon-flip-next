...
export default function Stats({ stats, originalStats }) {
    ...
    return (
        <div className="absolute top-0 left-0 bg-linear-to-b from-black/15 to-transparent px-1 pb-1 w-full flex">
            <div className="mt-0.5 font-mono text-[10px] md:text-xs z-20 font-bold leading-none text-shadow-md/100 md:text-shadow-md/50 flex flex-col justify-between text-center">                <div className={conditionalClass(1)}>{formattedStats[1]}</div>
